...
public class BossDieDialogComponent : MonoBehaviour
{
    ...
    void Start()
    {
        introDialog.Add("BOSS：啊!");
        introDialog.Add("BOSS：(看了看自己)");
        introDialog.Add("BOSS：謝謝你的幫忙。");
        introDialog.Add("稻禾：好了，你先回來一趟吧!");
        introDialog.Add("BOSS：诶?你給我使者令牌幹嘛?");
        introDialog.Add("(狐狸轉身離去)");
        introDialog.Add("稻禾：你要去哪裡?");
        introDialog.Add("稻禾：給我回來!");
        introDialog.Add("Fin");
